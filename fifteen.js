...
window.onload = function()
{
	...
	function changePic() 
	{
		var listOfPics = ["background.jpg","curry.jpg","messi.jpg","sheeran.jpg","cole.jpg"];
	...
	function CheckboxessetUp()
	{
		...
		// Creates the text label for the checkbox
		slideModeChkBoxlabel = document.createElement('label');
		slideModeChkBoxlabel.htmlFor = "changePicChkBox1";
		slideModeChkBoxlabel.appendChild(document.createTextNode('Easy Mode'));

		//Creates the checkbox
		slideModeChkBox = document.createElement("input");
	    slideModeChkBox.type = "checkbox";
	    slideModeChkBox.id = "slideModeChkBox1";
	    
	    // Adds the label to the controls div in the html code before
	    // appending the checkbox so that the text instructions appear 
	    // before the checkbox control itself 		
		document.getElementById("controls").appendChild(slideModeChkBoxlabel);
		document.getElementById("controls").appendChild(slideModeChkBox);
	}
};
